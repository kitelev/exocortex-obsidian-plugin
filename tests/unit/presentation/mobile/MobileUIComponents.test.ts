import { MobileUIComponents, TouchGestureRecognizer } from '../../../../src/presentation/components/MobileUIComponents';
...
describe('MobileUIComponents', () => {
    ...
    describe('Touch Button Creation', () => {
        ...
        it('should add icon to button', () => {
            ...
            expect(button.querySelector('.exocortex-mobile-button-icon')).toBeTruthy();
            expect(button.querySelector('.exocortex-mobile-button-icon')?.innerHTML).toBe('🏠');
        });
    });
    ...
    describe('Mobile List Creation', () => {
        ...
        it('should create list items with correct content', () => {
            ...
            expect(firstItem?.querySelector('.exocortex-mobile-list-item-title')?.textContent).toBe('Item 1');
            expect(firstItem?.querySelector('.exocortex-mobile-list-item-subtitle')?.textContent).toBe('Subtitle 1');
            expect(firstItem?.querySelector('.exocortex-mobile-list-item-icon')?.textContent).toBe('📄');
            expect(firstItem?.querySelector('.exocortex-mobile-list-item-right-text')?.textContent).toBe('Right 1');
            expect(firstItem?.querySelector('.exocortex-mobile-list-item-chevron')).toBeTruthy();
        });
        ...
        it('should handle item clicks', () => {
            ...
            const list = mobileUI.createList(container, sampleItems, onItemClick);
            const firstItem = list.querySelector('.exocortex-mobile-list-item') as HTMLElement;
        ...
        it('should use virtual scrolling for large lists when optimizer available', () => {
            (PlatformDetector.shouldUseVirtualScrolling as jest.Mock).mockReturnValue(true);
            
            const largeItemList = Array(200).fill(0).map((_, i) => ({
                title: `Item ${i}`,
                subtitle: `Subtitle ${i}`
            }));
    ...
    describe('Mobile Input Creation', () => {
        it('should create a mobile input', () => {
            ...
            const input = inputContainer.querySelector('.exocortex-mobile-input') as HTMLInputElement;

            expect(inputContainer).toBeInstanceOf(HTMLElement);
            expect(inputContainer.classList).toContain('exocortex-mobile-input-container');
        ...
        it('should create clear button on mobile', () => {
            ...
            expect(inputContainer.querySelector('.exocortex-mobile-input-clear')).toBeTruthy();
        });
        ...
        it('should handle disabled state', () => {
            ...
            expect(inputContainer.classList).toContain('exocortex-mobile-input-container--disabled');
        });
    ...
    describe('Mobile Modal Creation', () => {
        ...
        it('should create fullscreen modal', () => {
            ...
            const modalContent = modal.querySelector('.exocortex-mobile-modal');
            expect(modalContent?.classList).toContain('exocortex-mobile-modal--fullscreen');
        });
        ...
        it('should handle modal close', () => {
            ...
            const closeButton = modal.querySelector('.exocortex-mobile-modal-close') as HTMLElement;
            closeButton.click();
    ...
    describe('Loading Indicator', () => {
        it('should create loading indicator', () => {
            const loader = mobileUI.createLoadingIndicator(container, 'Loading data...');

            expect(loader).toBeInstanceOf(HTMLElement);
            expect(loader.classList).toContain('exocortex-mobile-loader');
            expect(loader.querySelector('.exocortex-mobile-spinner-large')).toBeTruthy();
        ...
        it('should create loader without message', () => {
            ...
            expect(loader.querySelector('.exocortex-mobile-loader-message')).toBeFalsy();
        });
    });
    ...
    describe('Swipe Actions', () => {
        it('should create swipeable list items', () => {
            ...
            const actions = listItem?.querySelector('.exocortex-mobile-list-item-actions');

            expect(actions).toBeTruthy();
            expect(actions?.querySelector('.exocortex-mobile-list-item-action')).toBeTruthy();
        });
        ...
        it('should handle swipe action clicks', () => {
            ...
            const list = mobileUI.createList(container, items);
            const actionButton = list.querySelector('.exocortex-mobile-list-item-action') as HTMLElement;
