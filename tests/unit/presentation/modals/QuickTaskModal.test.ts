...
import { CreateTaskRequest, CreateTaskResponse, GetCurrentProjectResponse } from '../../../../src/application/dtos/CreateTaskRequest';
...
describe('QuickTaskModal', () => {
  ...
  beforeEach(() => {
    ...
    modal = new QuickTaskModal(app, mockCreateTaskUseCase, mockGetCurrentProjectUseCase, 'test-file.md');
  ...
  describe('Modal Initialization', () => {
    ...
    it('should initialize with custom active file', () => {
      const customModal = new QuickTaskModal(app, mockCreateTaskUseCase, mockGetCurrentProjectUseCase, 'custom-file.md');
      expect((customModal as any).activeFile).toBe('custom-file.md');
    });

    it('should initialize without active file', () => {
      const customModal = new QuickTaskModal(app, mockCreateTaskUseCase, mockGetCurrentProjectUseCase);
  ...
  describe('Project Context Loading', () => {
    it('should handle successful project context loading', async () => {
      ...
      expect((modal as any).currentProject).toEqual(mockProjectResponse.currentProject);
      expect((modal as any).availableProjects).toEqual(mockProjectResponse.availableProjects);
    });
  ...
  describe('Button Event Handlers', () => {
    ...
    it('should handle create button click', async () => {
      ...
      const clickHandler = (mockContentEl.addEventListener as jest.Mock).mock.calls
  ...
  describe('Keyboard Events', () => {
    ...
    it('should handle Ctrl+Enter to create task', async () => {
      ...
      const keydownHandler = (mockContentEl.addEventListener as jest.Mock).mock.calls
        .find(call => call[0] === 'keydown')?.[1];
  ...
  describe('Error Handling', () => {
    ...
    it('should handle task creation with invalid response format', async () => {
      ...
      expect(Notice).toHaveBeenCalledWith('Task "undefined" created successfully');
      expect(result).toBe(true);
    });
  });
  ...
  describe('Style Management', () => {
    it('should call addStyles method', async () => {
      ...
      const addStylesSpy = jest.spyOn(modal as any, 'addStyles').mockImplementation(() => {});
    ...
    it('should create style element with proper content', () => {
      ...
      const createElementSpy = jest.spyOn(document, 'createElement').mockReturnValue(mockStyleElement as any);
