...
describe('CustomLayoutRenderingStrategy', () => {
    ...
    beforeEach(() => {
        ...
        mockBlockRendererFactory = {
            ...
            getSupportedBlockTypes: jest.fn().mockReturnValue(['properties', 'backlinks'])
    ...
    describe('Layout Rendering', () => {
        it('should render layout with visible blocks', async () => {
            ...
            expect(mockBlockRendererFactory.createRenderer).toHaveBeenCalledWith('properties');
            expect(mockBlockRendererFactory.createRenderer).toHaveBeenCalledWith('backlinks');
        ...
        it('should add layout metadata information', async () => {
            ...
            expect(layoutInfo?.getAttribute('data-layout-id')).toBe(layout.id.toString());
            expect(layoutInfo?.getAttribute('data-layout-class')).toBe(layout.targetClass.value);
        });
    });
    ...
    describe('Error Handling', () => {
        ...
        it('should handle block rendering failures gracefully', async () => {
            ...
            mockBlockRenderer.render.mockResolvedValue(Result.fail('Block rendering failed'));
    ...
    describe('Block Structure Creation', () => {
        it('should create proper block container structure', async () => {
            ...
            const blockContainer = container.querySelector('[data-block-id="test-props"]');
            expect(blockContainer).toBeTruthy();
            expect(blockContainer?.classList.contains('exocortex-block')).toBe(true);
            expect(blockContainer?.classList.contains('exocortex-block-properties')).toBe(true);
        ...
        it('should handle blocks without titles', async () => {
            ...
            const blockContainer = container.querySelector('[data-block-id="no-title"]');
            expect(blockContainer).toBeTruthy();
