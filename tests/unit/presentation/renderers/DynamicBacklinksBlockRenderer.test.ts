...
describe("DynamicBacklinksBlockRenderer", () => {
  ...
  beforeEach(() => {
    ...
    // Mock the service
    mockService = new DynamicBacklinksService(
      mockApp,
    ) as jest.Mocked<DynamicBacklinksService>;
  ...
  describe("render", () => {
    it("should display error message when service fails", async () => {
      ...
      expect(mockContainer.textContent).toContain(
        "Error discovering backlinks: Service error",
      );
    ...
    it("should display empty message when no backlinks found", async () => {
      ...
      expect(mockContainer.textContent).toContain(
        "No property-based backlinks found",
      );
    ...
    it("should render property groups with backlinks", async () => {
      ...
      expect(
        mockContainer.querySelector(".exocortex-dynamic-backlinks-group"),
      ).toBeTruthy();
      expect(
        mockContainer.querySelector(".exocortex-property-backlinks-header"),
      ).toBeTruthy();
      expect(
        mockContainer.querySelector(".exocortex-property-backlinks-list"),
      ).toBeTruthy();
    });
    ...
    it("should show empty property groups when showEmptyProperties is true", async () => {
      ...
      expect(mockContainer.textContent).toContain(
        "No files reference this asset via this property",
      );
    });
