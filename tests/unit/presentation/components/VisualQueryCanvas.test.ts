import { VisualQueryCanvas, CanvasOptions } from '../../../../src/presentation/components/VisualQueryCanvas';
import { VisualQueryNode, NodeType } from '../../../../src/domain/visual/VisualQueryNode';
import { VisualQueryEdge, EdgeType } from '../../../../src/domain/visual/VisualQueryEdge';
...
Object.defineProperty(document, 'createElementNS', {
    ...
    value: jest.fn((namespace: string, tagName: string) => {
        ...
        (element as any).querySelector = jest.fn().mockImplementation((selector: string) => {
            if (selector === 'rect') {
                return {
...
describe('VisualQueryCanvas', () => {
    ...
    beforeEach(() => {
        ...
        canvas = new VisualQueryCanvas(parentElement, mockOptions, mockSparqlProcessor);
    });
    ...
    describe('Node Management', () => {
        it('should add a node to the canvas', () => {
            const node = VisualQueryNode.createEntity('Test Entity', 'http://example.org/test', { x: 100, y: 100 });
            canvas.addNode(node);
        ...
        it('should remove connected edges when removing a node', () => {
            const node1 = VisualQueryNode.createEntity('Entity 1', undefined, { x: 100, y: 100 });
            const node2 = VisualQueryNode.createEntity('Entity 2', undefined, { x: 200, y: 200 });
            const edge = VisualQueryEdge.createProperty(node1.getId(), node2.getId(), 'connects');
        ...
        it('should create different types of nodes', () => {
            const entity = VisualQueryNode.createEntity('Entity', undefined, { x: 0, y: 0 });
            const variable = VisualQueryNode.createVariable('var1', { x: 100, y: 0 });
            const literal = VisualQueryNode.createLiteral('literal value', { x: 200, y: 0 });
            const filter = VisualQueryNode.createFilter('FILTER(?var > 0)', { x: 300, y: 0 });
            ...
            expect(Array.from(nodes.values()).find(n => n.getType() === NodeType.ENTITY)).toBeTruthy();
            expect(Array.from(nodes.values()).find(n => n.getType() === NodeType.VARIABLE)).toBeTruthy();
            expect(Array.from(nodes.values()).find(n => n.getType() === NodeType.LITERAL)).toBeTruthy();
            expect(Array.from(nodes.values()).find(n => n.getType() === NodeType.FILTER)).toBeTruthy();
        });
    });
    ...
    describe('Edge Management', () => {
        ...
        beforeEach(() => {
            node1 = VisualQueryNode.createEntity('Entity 1', undefined, { x: 100, y: 100 });
            node2 = VisualQueryNode.createEntity('Entity 2', undefined, { x: 200, y: 200 });
            canvas.addNode(node1);
            canvas.addNode(node2);
        });
        ...
        it('should not add edge with missing source or target node', () => {
            const edge = VisualQueryEdge.createProperty('missing-id', node2.getId(), 'connects');
            canvas.addEdge(edge);
        ...
        it('should create different types of edges', () => {
            const propertyEdge = VisualQueryEdge.createProperty(node1.getId(), node2.getId(), 'property');
            const optionalEdge = VisualQueryEdge.createOptional(node1.getId(), node2.getId(), 'optional');
            ...
            expect(Array.from(edges.values()).find(e => e.getType() === EdgeType.PROPERTY)).toBeTruthy();
            expect(Array.from(edges.values()).find(e => e.getType() === EdgeType.OPTIONAL)).toBeTruthy();
        });
    });
    ...
    describe('Selection Management', () => {
        ...
        beforeEach(() => {
            node1 = VisualQueryNode.createEntity('Entity 1', undefined, { x: 100, y: 100 });
            node2 = VisualQueryNode.createEntity('Entity 2', undefined, { x: 200, y: 200 });
            edge = VisualQueryEdge.createProperty(node1.getId(), node2.getId(), 'connects');
    ...
    describe('SPARQL Generation', () => {
        ...
        it('should generate simple triple pattern', () => {
            const subject = VisualQueryNode.createVariable('subject', { x: 100, y: 100 });
            const object = VisualQueryNode.createVariable('object', { x: 300, y: 100 });
            const edge = VisualQueryEdge.createProperty(subject.getId(), object.getId(), 'predicate');
        ...
        it('should handle filter nodes', () => {
            const variable = VisualQueryNode.createVariable('count', { x: 100, y: 100 });
            const filter = VisualQueryNode.createFilter('FILTER(?count > 10)', { x: 200, y: 200 });
        ...
        it('should handle optional patterns', () => {
            const subject = VisualQueryNode.createVariable('subject', { x: 100, y: 100 });
            const object = VisualQueryNode.createVariable('object', { x: 300, y: 100 });
            const edge = VisualQueryEdge.createOptional(subject.getId(), object.getId(), 'predicate');
    ...
    describe('Zoom and Pan', () => {
        it('should support zoom to fit', () => {
            const node1 = VisualQueryNode.createEntity('Entity 1', undefined, { x: 0, y: 0 });
            const node2 = VisualQueryNode.createEntity('Entity 2', undefined, { x: 400, y: 300 });
    ...
    describe('Canvas Operations', () => {
        it('should clear the canvas', () => {
            const node = VisualQueryNode.createEntity('Test Entity', undefined, { x: 100, y: 100 });
            canvas.addNode(node);
    ...
    describe('Event Handling', () => {
        it('should handle mouse events for interaction', () => {
            ...
            const node = VisualQueryNode.createEntity('Clickable Entity', undefined, { x: 100, y: 100 });
            canvas.addNode(node);
        ...
        it('should handle keyboard shortcuts', () => {
            ...
            const node = VisualQueryNode.createEntity('To Delete', undefined, { x: 100, y: 100 });
            canvas.addNode(node);
    ...
    describe('Edge Cases', () => {
        it('should handle nodes with same position', () => {
            const node1 = VisualQueryNode.createEntity('Entity 1', undefined, { x: 100, y: 100 });
            const node2 = VisualQueryNode.createEntity('Entity 2', undefined, { x: 100, y: 100 });
        ...
        it('should handle empty node labels', () => {
            const node = VisualQueryNode.createEntity('', undefined, { x: 100, y: 100 });
            canvas.addNode(node);
        ...
        it('should handle nodes outside canvas bounds', () => {
            const node = VisualQueryNode.createEntity('Outside', undefined, { x: -100, y: -100 });
            canvas.addNode(node);
