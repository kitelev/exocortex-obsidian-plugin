...
import { SecurityMonitor, SecurityEventType, SecuritySeverity, MonitorConfig } from '../../../src/infrastructure/security/SecurityMonitor';
...
describe('SecurityMonitor Tests', () => {
    ...
    describe('Event Logging', () => {
        ...
        it('should auto-generate action taken for events', () => {
            ...
            expect(criticalResult.getValue().details.actionTaken).toContain('blocked');
    ...
    describe('Alert System', () => {
        it('should create alerts for critical events', () => {
            ...
            alertMonitor.logInjectionAttempt(
                'malicious query',
                'sql_injection',
                ['drop_table']
            );
    ...
    describe('Forensic Logging', () => {
        ...
        it('should generate comprehensive security reports', () => {
            ...
            expect(['COMPLIANT', 'MINOR_ISSUES', 'NON_COMPLIANT']).toContain(report.complianceStatus);
        });
    });
    ...
    describe('Performance and Scalability', () => {
        ...
        it('should handle concurrent event logging', async () => {
            const promises = Array.from({ length: 100 }, (_, i) =>
                Promise.resolve(monitor.logSecurityEvent(
                    'query_blocked',
                    'medium',
                    'Test',
    ...
    describe('Error Handling and Edge Cases', () => {
        ...
        it('should handle memory cleanup correctly', () => {
            ...
            // Generate events
            for (let i = 0; i < 20; i++) {
                cleanupMonitor.logSecurityEvent(
                    'query_blocked',
                    'low',
                    'Test',
                    {}
