...
import { QueryComplexityAnalyzer, ComplexityThresholds } from '../../../src/infrastructure/security/QueryComplexityAnalyzer';
...
describe('QueryComplexityAnalyzer Security Tests', () => {
    ...
    describe('DoS Attack Prevention', () => {
        it('should block queries with excessive triple patterns', () => {
            ...
            expect(analysis.violations.some(v => v.includes('Triple patterns'))).toBe(true);
