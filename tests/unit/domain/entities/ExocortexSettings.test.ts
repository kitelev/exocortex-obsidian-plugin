import {
  ExocortexSettings,
  DEFAULT_SETTINGS,
} from "../../../../src/domain/entities/ExocortexSettings";
...
describe("ExocortexSettings", () => {
  ...
  describe("resetToDefaults", () => {
    it("should reset all settings to defaults", () => {
      ...
      expect(settings.get("enableDebugMode")).toBe(
        DEFAULT_SETTINGS.enableDebugMode,
      );
      expect(settings.get("layoutsFolderPath")).toBe(
        DEFAULT_SETTINGS.layoutsFolderPath,
      );
      expect(settings.get("sparqlCacheMaxSize")).toBe(
        DEFAULT_SETTINGS.sparqlCacheMaxSize,
      );
    });
  });
