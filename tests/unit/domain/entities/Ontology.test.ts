...
describe("Ontology", () => {
  ...
  describe("constructor", () => {
    it("should create Ontology with all parameters", () => {
      ...
      expect(ontology.getDescription()).toBe(
        "A test ontology for unit testing",
      );
    });
  ...
  describe("getDescription", () => {
    it("should return defined description", () => {
      const description =
        "This is a comprehensive ontology for testing purposes";
      const ontology = new Ontology({
        prefix: validPrefix,
        label: "Test",
        fileName: "test.md",
    ...
    it("should handle long descriptions", () => {
      const longDescription =
        "This is a very long description that spans multiple lines and contains various information about the ontology including its purpose, scope, and intended usage. ".repeat(
          10,
        );
  ...
  describe("fromFrontmatter", () => {
    ...
    it("should roundtrip correctly", () => {
      ...
      expect(recreatedOntology.getNamespace()).toBe(
        "http://example.org/roundtrip/",
      );
      expect(recreatedOntology.getDescription()).toBe(
