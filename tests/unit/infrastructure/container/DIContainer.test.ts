...
describe('DIContainer', () => {
    ...
    describe('Core Service Registration', () => {
        ...
        it('should register all repository interfaces', () => {
            expect(() => container.resolve<IAssetRepository>('IAssetRepository')).not.toThrow();
            expect(() => container.resolve<IOntologyRepository>('IOntologyRepository')).not.toThrow();
            expect(() => container.resolve<IClassLayoutRepository>('IClassLayoutRepository')).not.toThrow();
        });

        it('should register services with proper dependencies', () => {
            expect(() => container.resolve<ErrorHandlerService>('ErrorHandlerService')).not.toThrow();
        });

        it('should register use cases with dependencies', () => {
            expect(() => container.resolve<CreateAssetUseCase>('CreateAssetUseCase')).not.toThrow();
        });

        it('should register presentation components', () => {
            expect(() => container.resolve<ButtonRenderer>('ButtonRenderer')).not.toThrow();
            expect(() => container.resolve<LayoutRenderer>('LayoutRenderer')).not.toThrow();
        });
    });
    ...
    describe('Dependency Injection Chain', () => {
        ...
        it('should resolve dependencies recursively', () => {
            const createAssetUseCase = container.resolve<CreateAssetUseCase>('CreateAssetUseCase');
    ...
    describe('Service Factories and Caching', () => {
        ...
        it('should create new instances from factories', () => {
            const service1 = container.resolve<CreateAssetUseCase>('CreateAssetUseCase');
            const service2 = container.resolve<CreateAssetUseCase>('CreateAssetUseCase');
    ...
    describe('Service Resolution Methods', () => {
        ...
        it('should provide convenience methods for common use cases', () => {
            expect(container.getCreateAssetUseCase()).toBeInstanceOf(CreateAssetUseCase);
        ...
        it('should provide convenience methods for specialized use cases', () => {
            expect(container.getPropertyEditingUseCase()).toBeInstanceOf(PropertyEditingUseCase);
        ...
        it('should maintain consistency between resolve and convenience methods', () => {
            const resolvedDirectly = container.resolve<CreateAssetUseCase>('CreateAssetUseCase');
    ...
    describe('Backward Compatibility', () => {
        ...
        it('should handle async initialize without changing state', async () => {
            const serviceBefore = container.resolve<CreateAssetUseCase>('CreateAssetUseCase');
            await container.initialize(app);
            const serviceAfter = container.resolve<CreateAssetUseCase>('CreateAssetUseCase');
    ...
    describe('Service Override and Testing Support', () => {
        ...
        it('should allow service re-registration through container clear and re-init', () => {
            // Get initial service
            const initialService = container.resolve<CreateAssetUseCase>('CreateAssetUseCase');
            ...
            const newService = container.resolve<CreateAssetUseCase>('CreateAssetUseCase');
    ...
    describe('DIContainer Edge Cases and Error Handling', () => {
        ...
        describe('Concurrent Access Patterns', () => {
            it('should handle concurrent service resolution', () => {
                ...
                for (let i = 0; i < 10; i++) {
                    promises.push(Promise.resolve().then(() => {
                        return container.resolve<CreateAssetUseCase>('CreateAssetUseCase');
                    }));
                }
            ...
            it('should handle mixed initialization and resolution', () => {
                ...
                const service2 = container2.resolve<CreateAssetUseCase>('CreateAssetUseCase');
        ...
        describe('Service Factory Complexity', () => {
            it('should handle factories with complex dependencies', () => {
                ...
                const layoutRenderer = container.resolve<LayoutRenderer>('LayoutRenderer');
            ...
            it('should handle factory returning class constructor', () => {
                ...
                const ResolvedClass = baseContainer.resolve<typeof TestClass>('ClassService');
    ...
    describe('Integration Scenarios', () => {
        ...
        it('should handle complex service interaction patterns', () => {
            ...
            const repository = container.resolve<IClassLayoutRepository>('IClassLayoutRepository');
