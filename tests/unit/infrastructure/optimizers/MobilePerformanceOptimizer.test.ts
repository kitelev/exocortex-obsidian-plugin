import {
  ...
  OptimizationConfig,
  PerformanceMetrics,
} from "../../../../src/infrastructure/optimizers/MobilePerformanceOptimizer";
...
describe("MobilePerformanceOptimizer", () => {
  ...
  describe("Batch Processing", () => {
    ...
    it("should handle processing errors gracefully", async () => {
      ...
      await expect(optimizer.processBatch(items, processor)).rejects.toThrow(
        "Processing failed",
      );
    });
  ...
  describe("Image Optimization", () => {
    ...
    it("should resize large images", async () => {
      ...
      const imageFile = new File(["large image"], "large.jpg", {
        type: "image/jpeg",
      });

      await optimizer.optimizeImage(imageFile, {
        maxWidth: 800,
        maxHeight: 600,
      });
  ...
  describe("Error Handling", () => {
    ...
    it("should handle image optimization errors", async () => {
      ...
      await expect(optimizer.optimizeImage(imageFile)).rejects.toThrow(
