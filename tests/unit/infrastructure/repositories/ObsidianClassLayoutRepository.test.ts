...
describe('ObsidianClassLayoutRepository', () => {
    ...
    describe('Constructor and Initialization', () => {
        ...
        it('should handle null app gracefully', () => {
            expect(() => new ObsidianClassLayoutRepository(null as any)).not.toThrow();
        });
    });
    ...
    describe('Cache Management', () => {
        ...
        it('should clear cache on loadLayoutsFromFiles', async () => {
            ...
            const freshRepository = new ObsidianClassLayoutRepository(mockApp, 'test-layouts');
    ...
    // Helper functions
    function createMockLayout(id: string, targetClass: ClassName, isEnabled: boolean = true, priority: number = 1): any {
        const assetId = {
    ...
    describe('Data Consistency and Validation', () => {
        it('should validate layout data consistency across operations', async () => {
            ...
            // Update layout
            const updatedLayout = { ...originalLayout, priority: 10, isEnabled: false };
            await repository.save(updatedLayout);
    ...
    describe('Memory Management and Performance', () => {
        it('should handle large cache sizes efficiently', async () => {
            ...
            for (let classIndex = 0; classIndex < 10; classIndex++) {
                ...
                for (let layoutIndex = 0; layoutIndex < 5; layoutIndex++) {
                    largeDataset.push(createMockLayout(
            ...
            const class1Layouts = await repository.findByClass(ClassName.create('Class1').getValue());
            const enabledClass1 = await repository.findEnabledByClass(ClassName.create('Class1').getValue());
        ...
        it('should clean up cache efficiently during delete operations', async () => {
            ...
            await Promise.all(layoutsToDelete.map(layout => repository.delete(layout.id)));
