import { CreateAssetUseCase, CreateAssetRequest, CreateAssetResponse } from '../../../../src/application/use-cases/CreateAssetUseCase';
...
describe('CreateAssetUseCase', () => {
    ...
    beforeEach(() => {
        ...
        useCase = new CreateAssetUseCase(mockAssetRepository, mockOntologyRepository);
    });
    ...
    describe('Basic Functionality', () => {
        ...
        test('should accept valid repositories in constructor', () => {
            const newUseCase = new CreateAssetUseCase(mockAssetRepository, mockOntologyRepository);
    ...
    describe('Request Validation', () => {
        ...
        test('should throw error for empty title', async () => {
            ...
            await expect(useCase.execute(request)).rejects.toThrow('Asset title is required');
        });
        ...
        test('should throw error for missing className', async () => {
            ...
            await expect(useCase.execute(request)).rejects.toThrow('Asset class is required');
        });
        ...
        test('should throw error for missing ontologyPrefix', async () => {
            ...
            await expect(useCase.execute(request)).rejects.toThrow('Ontology prefix is required');
        });
    ...
    describe('Ontology Repository Integration', () => {
        ...
        test('should throw error when ontology not found', async () => {
            ...
            await expect(useCase.execute(request)).rejects.toThrow('Ontology nonexistent not found');
        });
    ...
    describe('Asset Creation Process', () => {
        ...
        test('should handle asset creation failure', async () => {
            ...
            Asset.create = jest.fn().mockReturnValue(Result.fail<Asset>('Asset creation failed'));
            ...
            await expect(useCase.execute(request)).rejects.toThrow('Asset creation failed');
    ...
    describe('Error Scenarios', () => {
        ...
        test('should handle network errors', async () => {
            ...
            await expect(useCase.execute(request)).rejects.toThrow('Network unreachable');
        });
