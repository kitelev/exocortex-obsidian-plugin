...
import { QueryTemplate, TemplateCategory, TemplateMetadata } from '../../../../src/domain/visual/QueryTemplate';
...
describe('QueryTemplateUseCase', () => {
    ...
    describe('Template Retrieval', () => {
        ...
        it('should get templates by category', async () => {
            ...
            const result = await useCase.getTemplatesByCategory(TemplateCategory.EXPLORATION);

            expect(mockTemplateRepository.findByCategory).toHaveBeenCalledWith(TemplateCategory.EXPLORATION);
            expect(result).toEqual(mockTemplates);
        });
    ...
    describe('Template Management', () => {
        ...
        it('should prevent saving built-in templates', async () => {
            ...
            await expect(useCase.saveTemplate(builtInTemplate))
        ...
        it('should clone a template', async () => {
            ...
            const result = await useCase.cloneTemplate('test-template', 'Cloned Template');
        ...
        it('should throw error when cloning non-existent template', async () => {
            ...
            await expect(useCase.cloneTemplate('nonexistent'))
        ...
        it('should prevent deleting built-in templates', async () => {
            ...
            await expect(useCase.deleteTemplate('builtin-test'))
    ...
    describe('Template Instantiation', () => {
        ...
        it('should throw error when instantiating template with invalid parameters', async () => {
            ...
            await expect(useCase.instantiateTemplate(parameterizedTemplate))
    ...
    describe('Import/Export', () => {
        ...
        it('should throw error for invalid JSON in import', async () => {
            ...
            await expect(useCase.importTemplates(invalidJson))
        ...
        it('should throw error for non-array JSON in import', async () => {
            ...
            await expect(useCase.importTemplates(nonArrayJson))
    ...
    describe('Statistics and Analytics', () => {
        ...
        it('should throw error when previewing non-existent template', async () => {
            ...
            await expect(useCase.getTemplatePreview('nonexistent'))
                .rejects.toThrow('Template with ID nonexistent not found');
        });
    });
    ...
    describe('Template Validation', () => {
        it('should validate template parameters comprehensively', async () => {
            ...
            const result = await useCase.validateTemplateParameters(parameterizedTemplate);
