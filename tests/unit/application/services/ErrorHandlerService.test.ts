import {
  ...
  ErrorHandlerOptions,
  ErrorMetrics,
} from "../../../../src/application/services/ErrorHandlerService";
import {
  ExocortexError,
  ErrorSeverity,
  ErrorCategory,
  ErrorBuilder,
  FixSuggestion,
} from "../../../../src/domain/errors/ExocortexError";
...
describe("ErrorHandlerService", () => {
  ...
  describe("handleError", () => {
    ...
    it("should handle string error successfully", async () => {
      ...
      const result =
        await errorHandlerService.handleError("Test error message");
  ...
  describe("markErrorResolved", () => {
    ...
    it("should calculate average resolution time correctly", async () => {
      const mockError1: ExocortexError = {
        ...createMockExocortexError(),
        id: "error1",
      };
      const mockError2: ExocortexError = {
        ...createMockExocortexError(),
        id: "error2",
      };

      mockAnalyzer.analyze
        .mockReturnValueOnce(mockError1)
        .mockReturnValueOnce(mockError2);
  ...
  describe("getSuggestions", () => {
    ...
    it("should return empty array when no suggestions available", () => {
      ...
      const suggestions = errorHandlerService.getSuggestions(
