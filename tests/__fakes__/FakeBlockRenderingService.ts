...
export class FakeBlockRenderingService extends BlockRenderingService {
    private renderedBlocks: Array<{ block: LayoutBlock; context: RenderContext }> = [];
    ...
    private registerFakeStrategies(): void {
        const allBlockTypes = ['query', 'properties', 'backlinks', 'children-efforts', 'narrower', 'buttons', 'custom'];
