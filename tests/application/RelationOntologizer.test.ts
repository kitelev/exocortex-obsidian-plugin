...
import { RelationAsset, RelationAssetHelper } from '../../src/domain/entities/RelationAsset';
...
describe('RelationOntologizer', () => {
    ...
    describe('RelationAssetHelper', () => {
        ...
        test('should get correct inverse predicates', () => {
            expect(RelationAssetHelper.getInversePredicate('ems__Task_project'))
                .toBe('ems__Project_hasTasks');
            
            expect(RelationAssetHelper.getInversePredicate('ems__partOf'))
                .toBe('ems__hasPart');
            
            expect(RelationAssetHelper.getInversePredicate('exo__subClassOf'))
                .toBe('exo__superClassOf');
            
            // Test unknown predicate
            expect(RelationAssetHelper.getInversePredicate('custom__unknownProp'))
                .toBe('custom__inverseOf_unknownProp');
        });
        
        test('should extract ontology from predicate', () => {
            expect(RelationAssetHelper.extractOntology('ems__Task_project')).toBe('ems');
            expect(RelationAssetHelper.extractOntology('exo__Asset_relates')).toBe('exo');
