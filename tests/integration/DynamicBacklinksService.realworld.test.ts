...
describe("DynamicBacklinksService - Real World Scenarios", () => {
  ...
  describe("User Reported Issues", () => {
    it("should discover backlinks from Projects and Tasks to Area in real vault structure", async () => {
      ...
      const businessTripProject = createMockFile(
        "03 Knowledge/toos/Project - Командировка с 7 по 11 в Питер.md",
        {
      ...
      const reviewTask = createMockFile(
        "03 Knowledge/kitelev/Task - Провести ревью PDR по обмену опытом.md",
        {
          exo__Asset_isDefinedBy: "[[Ontology - kitelev]]",
      ...
      const pluginProject = createMockFile(
        "03 Knowledge/kitelev/Project - Динамические лейауты.md",
        {
          exo__Asset_isDefinedBy: "[[Ontology - kitelev]]",
