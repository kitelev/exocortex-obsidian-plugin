...
export class AssetBuilder {
  ...
  private addAssetTriples(asset: Asset): void {
    ...
    // Basic type triple
    this.graph.add(new Triple(assetIRI, "rdf:type", this.className));
...
export class GraphBuilder {
  ...
  addOntology(ontologyName: string): GraphBuilder {
    ...
    classes.forEach((cls) => {
      this.graph.add(
        new Triple(`${ontologyName}:${cls}`, "rdf:type", "owl:Class"),
      );
    });
    ...
    properties.forEach((prop) => {
      this.graph.add(
        new Triple(`${ontologyName}:${prop}`, "rdf:type", "owl:ObjectProperty"),
      );
    });
...
export class ScenarioBuilder {
  ...
  projectManagementScenario(): ScenarioBuilder {
    ...
    // Create tasks
    ["Design Phase", "Development Phase", "Testing Phase"].forEach(
      (taskName, index) => {
    ...
    this.withTriple(":Enterprise_Project")
      .with("ems:hasTask")
      .equals(":Design_Phase");
    this.withTriple(":Enterprise_Project")
      .with("ems:hasTask")
  ...
  knowledgeManagementScenario(): ScenarioBuilder {
    ...
    // Create relationships
    this.withTriple(":Technology_Area")
      .with("ems:contains")
