...
describe('Exocortex plugin', () => {
  ...
  it('should execute the “exo-first-notice” command without error', async () => {
    ...
    await browser.executeAsync(async (done) => {
      ...
      // The command ID is defined in the plugin’s onload() method.  If
      // you change the ID in your plugin code, update it here as well.
      await app.commands.executeCommandById('exo-first-notice');
      done(true);
    });
  });
});
