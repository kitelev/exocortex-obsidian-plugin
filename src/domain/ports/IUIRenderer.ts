...
export interface UIElement {
    readonly type: 'container' | 'text' | 'link' | 'button' | 'list' | 'table' | 'header' | 'custom';
    readonly id: string;
...
export interface IUIRenderer {
    ...
    removeEventHandler(elementId: string, eventType: string): Promise<Result<void>>;
    ...
    setStyle(elementId: string, property: string, value: string): Promise<Result<void>>;
}