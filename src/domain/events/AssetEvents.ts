...
export class AssetTitleUpdatedEvent extends AssetDomainEvent {
  constructor(assetId: AssetId, oldTitle: string, newTitle: string) {
...
export class AssetClassChangedEvent extends AssetDomainEvent {
  constructor(assetId: AssetId, oldClassName: string, newClassName: string) {
...
export class AssetPropertyRemovedEvent extends AssetDomainEvent {
  constructor(assetId: AssetId, propertyKey: string, removedValue: any) {
...
export class AssetRestoredEvent extends AssetDomainEvent {
  constructor(assetId: AssetId, className: string, title: string) {
...
export class AssetSynchronizedEvent extends AssetDomainEvent {
  constructor(assetId: AssetId, syncSource: string, changes: string[]) {
...
export class AssetEventFactory {
  ...
  static propertyUpdated(
    ...
    return new AssetPropertyUpdatedEvent(
      assetId,
      propertyKey,
      oldValue,
      newValue,
