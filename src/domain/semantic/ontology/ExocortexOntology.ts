...
export function createEMSOntology(): Result<Ontology> {
  ...
  for (const status of statusValues) {
    const statusIri = new IRI(
      `https://exocortex.io/ontology/ems#${status.iri}`,
    );
...
export function createIMSOntology(): Result<Ontology> {
  ...
  const imsProperties: PropertyDefinition[] = [
    ...
    },
    {
      ...
      domain: [
        new IRI("https://exocortex.io/ontology/ims#Note"),
        new IRI("https://exocortex.io/ontology/ims#MOC"),
      ],
      range: EXO.Asset,
      required: false,
      multiple: true,
