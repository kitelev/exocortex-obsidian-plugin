...
describe("AgentTemplateSystem", () => {
  ...
  beforeEach(() => {
    ...
    mockRequirements = {
      ...
      constraints: [
        {
          type: "technical",
          description: "Must support Jest framework",
          impact: "high",
        },
      ],
  ...
  describe("Template Selection", () => {
    it("should select appropriate template for engineering domain", async () => {
      const result = templateSystem.selectTemplate(
        "engineering",
        mockRequirements,
      );
  ...
  describe("Agent Generation from Template", () => {
    it("should generate complete agent file from template", async () => {
      const templateResult = templateSystem.selectTemplate(
        "testing",
        mockRequirements,
      );
      const template = templateResult.getValue()!;

      const result = templateSystem.generateAgentFromTemplate(
        template,
        mockAgentSpec,
      );
  ...
  describe("Template Metrics", () => {
    it("should update template usage metrics", async () => {
      ...
      expect(template.metadata.successRate).toBeGreaterThanOrEqual(
        initialSuccessRate,
      );
    });
    ...
    it("should select appropriate modules for composition", async () => {
      const securityRequirements: AgentRequirements = {
        ...
        constraints: [
          {
            type: "security",
            description: "Must follow security standards",
            impact: "critical",
          },
        ],
        dependencies: [],
