...
export class InstancesBlockRenderer {
  ...
  async render(
    ...
    for (const otherFile of allFiles) {
      ...
      if (
        this.isReferencingCurrentAsset(instanceClassValue, currentAssetName)
      ) {
  ...
  private isReferencingCurrentAsset(
    ...
    const refs = Array.isArray(instanceClassValue)
      ? instanceClassValue
      : [instanceClassValue];
  ...
  private renderInstancesTable(
    ...
    headerRow.createEl("th", {
      text: "Instance Name",
      cls: "exocortex-table-header-name",
    });

    if (config.showInstanceInfo) {
      headerRow.createEl("th", {
        text: "Class",
        cls: "exocortex-table-header-class",
      });
      headerRow.createEl("th", {
        text: "Description",
        cls: "exocortex-table-header-description",
      });
    }
  ...
  private renderGroupedInstances(
    ...
    sortedGroups.forEach(([className, groupFiles]) => {
      ...
      this.renderFlatInstances(groupContainer, groupFiles, {
        ...config,
        groupByClass: false,
      });
    });
