...
export class NarrowerBlockRenderer {
  ...
  async render(
    ...
    const broaderProperty =
      narrowerConfig.broaderProperty || "ims__Concept_broader";
  ...
  private findNarrowerConcepts(file: TFile, broaderProperty: string): TFile[] {
    ...
    return this.app.vault.getFiles().filter((candidateFile) => {
      ...
      return this.referencesFile(
        ...
        currentFileLink,
        currentFilePath,
        currentFilePathWithoutExtension,
      );
    });
  }
