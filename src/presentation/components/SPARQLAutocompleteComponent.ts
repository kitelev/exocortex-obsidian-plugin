...
export class SPARQLAutocompleteComponent {
    ...
    async show(query: string, cursorPosition: number, anchorElement: HTMLElement): Promise<void> {
    ...
    private createSuggestionElement(suggestion: SPARQLSuggestion, index: number): HTMLLIElement {
    ...
    private getTypeColors(type: SuggestionType): { bg: string; text: string; border: string } {
        const isDark = document.body.classList.contains('theme-dark');
        
        const lightColors: Record<SuggestionType, { bg: string; text: string; border: string }> = {
            [SuggestionType.KEYWORD]: { bg: '#e3f2fd', text: '#1565c0', border: '#bbdefb' },
            [SuggestionType.FUNCTION]: { bg: '#f3e5f5', text: '#7b1fa2', border: '#ce93d8' },
            [SuggestionType.PREFIX]: { bg: '#e8f5e8', text: '#2e7d32', border: '#c8e6c9' },
            [SuggestionType.VARIABLE]: { bg: '#fff3e0', text: '#ef6c00', border: '#ffcc02' },
            [SuggestionType.PROPERTY]: { bg: '#fce4ec', text: '#c2185b', border: '#f48fb1' },
            [SuggestionType.CLASS]: { bg: '#e0f2f1', text: '#00695c', border: '#80cbc4' },
            [SuggestionType.NAMESPACE]: { bg: '#f1f8e9', text: '#558b2f', border: '#c5e1a5' },
            [SuggestionType.OPERATOR]: { bg: '#ede7f6', text: '#512da8', border: '#b39ddb' },
            [SuggestionType.TEMPLATE]: { bg: '#fafafa', text: '#424242', border: '#e0e0e0' }
        };
        
        const darkColors: Record<SuggestionType, { bg: string; text: string; border: string }> = {
            [SuggestionType.KEYWORD]: { bg: 'rgba(33, 150, 243, 0.2)', text: '#90caf9', border: 'rgba(33, 150, 243, 0.3)' },
            [SuggestionType.FUNCTION]: { bg: 'rgba(156, 39, 176, 0.2)', text: '#ce93d8', border: 'rgba(156, 39, 176, 0.3)' },
            [SuggestionType.PREFIX]: { bg: 'rgba(76, 175, 80, 0.2)', text: '#81c784', border: 'rgba(76, 175, 80, 0.3)' },
            [SuggestionType.VARIABLE]: { bg: 'rgba(255, 152, 0, 0.2)', text: '#ffb74d', border: 'rgba(255, 152, 0, 0.3)' },
            [SuggestionType.PROPERTY]: { bg: 'rgba(233, 30, 99, 0.2)', text: '#f48fb1', border: 'rgba(233, 30, 99, 0.3)' },
            [SuggestionType.CLASS]: { bg: 'rgba(0, 150, 136, 0.2)', text: '#4db6ac', border: 'rgba(0, 150, 136, 0.3)' },
            [SuggestionType.NAMESPACE]: { bg: 'rgba(139, 195, 74, 0.2)', text: '#aed581', border: 'rgba(139, 195, 74, 0.3)' },
            [SuggestionType.OPERATOR]: { bg: 'rgba(103, 58, 183, 0.2)', text: '#b39ddb', border: 'rgba(103, 58, 183, 0.3)' },
            [SuggestionType.TEMPLATE]: { bg: 'rgba(158, 158, 158, 0.2)', text: '#bdbdbd', border: 'rgba(158, 158, 158, 0.3)' }
        };
