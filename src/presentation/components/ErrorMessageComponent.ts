...
export class ErrorMessageComponent {
  ...
  render(): HTMLElement {
    ...
    if (
      this.error.context.location &&
      typeof this.error.context.location === "object"
    ) {
    ...
    if (
      ...
      this.error.suggestions.length > 0 &&
  ...
  private createLocationInfo(): HTMLElement {
    ...
    locationDiv.className =
      "error-location text-xs text-gray-600 mb-2 font-mono";
  ...
  private createSuggestions(): HTMLElement {
    ...
    suggestionsDiv.className =
      "error-suggestions mt-3 pt-3 border-t border-gray-200";
  ...
  private createTechnicalDetails(): HTMLElement {
    ...
    details.className =
      "error-technical-details mt-3 pt-3 border-t border-gray-200";
  ...
  private createActions(): HTMLElement {
    const actions = document.createElement("div");
    actions.className =
      "error-actions flex gap-2 mt-3 pt-3 border-t border-gray-200";
    ...
    if (this.options.onDismiss) {
      ...
      dismissButton.className =
        "px-3 py-1 text-sm bg-gray-300 text-gray-700 rounded hover:bg-gray-400";
