...
export class TemplateSelectionPanel {
    ...
    private filterTemplates(): void {
        ...
        const selectedCategory = this.categoryFilter.value as TemplateCategory || undefined;
    ...
    private createPreviewSection(title: string, content: string, isCode = false): HTMLDivElement {
    ...
    private createParametersSection(parameters: TemplateParameter[]): HTMLDivElement {
        const section = document.createElement('div');
