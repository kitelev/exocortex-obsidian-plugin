...
export const config = {
  ...
  onPrepare: function () {
    ...
    console.log(
      "💡 For full Obsidian tests, run: FORCE_OBSIDIAN_DOWNLOAD=true npm run test:ui",
    );
  ...
  before: async function () {
    ...
    (browser as any).addCommand(
      "executeObsidian",
      async function (script: Function) {
  ...
  after: async function () {
    ...
    console.log(
      "💡 Note: These were mocked tests. For full integration, use CI environment.",
    );
  },
