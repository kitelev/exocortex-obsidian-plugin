const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AssetRelationsTable-I56SX5mf.js","assets/jsx-runtime-BX3UmbFx.js","assets/ChildrenEffortsTable-BLBOihJk.js","assets/PropertyDisplay-BGe6RBD3.js"])))=>i.map(i=>d[i]);
...
const _Users_kitelev_Documents_exocortex_obsidian_plugin_src_presentation_components_AssetRelationsTable_AssetRelationsTable = () => __vitePreload(() => import('./AssetRelationsTable-I56SX5mf.js'),true              ?__vite__mapDeps([0,1]):void 0).then((mod) => mod.AssetRelationsTable);
const _Users_kitelev_Documents_exocortex_obsidian_plugin_src_presentation_components_ChildrenEffortsTable_ChildrenEffortsTable = () => __vitePreload(() => import('./ChildrenEffortsTable-BLBOihJk.js'),true              ?__vite__mapDeps([2,1]):void 0).then((mod) => mod.ChildrenEffortsTable);
const _Users_kitelev_Documents_exocortex_obsidian_plugin_src_presentation_components_PropertyDisplay_PropertyDisplay = () => __vitePreload(() => import('./PropertyDisplay-BGe6RBD3.js'),true              ?__vite__mapDeps([3,1]):void 0).then((mod) => mod.PropertyDisplay);
__pwRegistry.initialize({ _Users_kitelev_Documents_exocortex_obsidian_plugin_src_presentation_components_AssetRelationsTable_AssetRelationsTable,
  _Users_kitelev_Documents_exocortex_obsidian_plugin_src_presentation_components_ChildrenEffortsTable_ChildrenEffortsTable,
  _Users_kitelev_Documents_exocortex_obsidian_plugin_src_presentation_components_PropertyDisplay_PropertyDisplay });

export { React as R, getDefaultExportFromCjs as g, reactExports as r };
//# sourceMappingURL=index-DosZHr-4.js.map
